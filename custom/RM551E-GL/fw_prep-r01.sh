...
rm -rf /usrdata/overlay-work/etc-upper/*
rm -rf /usrdata/overlay-work/.etc-work/*
...
capture() {
	...
	echo "Capturing directories needed for usrdata.ubi to /usrdata/usrdata.tar.gz"
    	tar -czf /usrdata/usrdata.tar.gz /usrdata/rootfs /usrdata/rootfs-workdir /usrdata/overlay-work/
